...
$nilai = 41.7;
    ...
    if ($nilai >= 81 AND $nilai <= 100) {
        ...
        echo " nilai anda $nilai  Akreditasi anda <b>B+</b> Bobot anda 3,3";
    }elseif ($nilai >= 70 AND $nilai < 74.99) {
        echo " nilai anda $nilai Akreditasi anda <b>B</b> Bobot anda 3";
    }elseif ($nilai >= 65 AND $nilai < 69.99) {
        echo " nilai anda $nilai Akreditasi anda <b>B-</b> Bobot anda 2,7";
